...
func TestStatefulNewStateMachineError(t *testing.T) {
	...
	tc := newStubTestCase(t, libhegel.StateMachine(0), int64(0), libhegel.E_BACKEND, "boom")
...
func TestStatefulNextGroupError(t *testing.T) {
	t.Parallel()
	tc := newStubTestCase(t,
		libhegel.StateMachine(0), int64(1), libhegel.OK, // new_state_machine
...
func TestStatefulInitialInvariantError(t *testing.T) {
	...
	// start_span(STATEFUL).
	tc := newStubTestCase(t, libhegel.StateMachine(0), int64(1), libhegel.OK, libhegel.E_BACKEND, "boom")
